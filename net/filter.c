...
static char *netfilter_get_name(Object *obj, Error **errp)
{
    NetFilterState *nf = NETFILTER(obj);

    return g_strdup(nf->name);
}

static void netfilter_set_name(Object *obj, const char *str, Error **errp)
{
    NetFilterState *nf = NETFILTER(obj);

    nf->name = g_strdup(str);
}
...
static void netfilter_init(Object *obj)
{
    ...
    object_property_add_str(obj, "name",
                            netfilter_get_name, netfilter_set_name, NULL);
    object_property_add_str(obj, "netdev_id",
